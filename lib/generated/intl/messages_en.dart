...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "armor2Text1": MessageLookupByLibrary.simpleMessage(
            "The armor is the piece of armor that covers the torso, where the vital organs are located, this is very important, since a wound to one of these organs can be fatal. Christ is righteousness 1 Corinthians 1:30 "),
        ...
        "armor2TextPractice1": MessageLookupByLibrary.simpleMessage(
            "If someone sues you for any reason without reason, God\'s justice will protect you, If you walk in it, since you have acted righteously and are known as a truthful Christian, all attacks are destined to perish. He and not you will exhibit your justice as the light in its time."),
        ...
        "armor3Text13": MessageLookupByLibrary.simpleMessage(
            "You will have to unleash the spiritual battle first and the fruit of it will be peace. As it is written in Isaiah 32:17, "),
        ...
        "armor4TextBible1": MessageLookupByLibrary.simpleMessage(
            "In the Bible we can see a case of someone wounded by an arrow and that is Saul, the first king of Israel. When the women of Israel sang the song “Saul has killed his thousands, and David his ten thousands,“ "),
        ...
        "armor4TextBible4": MessageLookupByLibrary.simpleMessage(
            "the devil took this opportunity to poison his mind with the thought that David was a threat to his family and his Kingdom. In the last few chapters, we notice how the evil one manipulated Saul through that arrow of fire when he went several times to kill David. Had he used the shield correctly, he would have had faith in the thought that the same God who anointed him as king will surely defend his kingdom against all threats."),
        ...
        "armor6Text9": MessageLookupByLibrary.simpleMessage(
            "Only then is it effective when it comes from the wisdom of God. Another aspect that we must consider is what it says "),
